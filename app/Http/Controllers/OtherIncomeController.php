...
class OtherIncomeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('other_income.create', compact('types', 'custom_fields', 'chart_assets','members'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $other_income->member_id=$request->member_id;
        $date = explode('-', $request->date);
        $other_income->year = $date[0];
        $other_income->month = $date[1];
        $other_income->branch_id=session("branch_id");
        $files = array();
        /*
            ...
            if ($data->count()) {
                foreach ($data as $key => $value) {
                    ...
                    if(!empty($member)) {
                        ...
                        $other_income->amount = $value->amount;
                        // $other_income->notes = $request->notes;
                        $other_income->date = date('Y-m-d');

                        $other_income->member_id = $member->id;
