                ...
                <div class="tab-pane fade in active" id="profile">
                    <div class="panel panel-white">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tr><td>Photo</td><td> @if(!empty($borrower->photo))
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h6><b>BUSINESS DETAILS</b>
                                    </h6>
                                    <table class="table table-striped table-hover">
                                        <tr>
                                            <td><b>Business Type</b></td>
                                            <td>{{$borrower->business_type}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>Business Location</b></td>
                                            <td>{{$borrower->business_location}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>Year Business started</b></td>
                                            <td>{{$borrower->year_started}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>Ownership</b></td>
                                            <td>{{$borrower->ownership}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>Estimated Stock Value</b></td>
                                            <td>{{$borrower->stock_value}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>Licensed</b></td>
                                            <td>{{$borrower->licensed}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>License Number</b></td>
                                            <td>{{$borrower->licence_no}}</td>
                                        </tr>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h6><b>NEXT OF KIN DETAILS</b>
                                    </h6>
                                    <table class="table table-striped table-hover">
                                        <tr>
                                            <td><b>{{trans_choice('general.first_name',1)}}</b></td>
                                            <td>{{$borrower->next_surname}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>{{trans_choice('general.last_name',1)}}</b></td>
                                            <td>{{$borrower->next_other}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>{{trans_choice('general.relationship',1)}}</b></td>
                                            <td>{{$borrower->next_relationship}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>{{trans_choice('general.dob',1)}}</b></td>
                                            <td>{{$borrower->next_dob}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>{{trans_choice('general.id',1)}}</b></td>
                                            <td>{{$borrower->next_id}}</td>
                                        </tr>
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                        href="{{url('communication/sms/create?borrower_id='.$borrower->id)}}">
                                                    {{$borrower->next_mobile}}
                                                </a>
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tr><td>Photo</td><td> @if(!empty($borrower->next_photos))
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h6><b>TRUSTEE DETAILS</b>
                                    </h6>
                                    <table class="table table-striped table-hover">
                                        <tr>
                                            <td><b>{{trans_choice('general.first_name',1)}}</b></td>
                                            <td>{{$borrower->trustee_surname}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>{{trans_choice('general.last_name',1)}}</b></td>
                                            <td>{{$borrower->trustee_other}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>{{trans_choice('general.relationship',1)}}</b></td>
                                            <td>{{$borrower->trustee_relationship}}</td>
                                        </tr>

                                        <tr>
                                            <td><b>{{trans_choice('general.id',1)}}</b></td>
                                            <td>{{$borrower->trustee_id}}</td>
                                        </tr>
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                        href="{{url('communication/sms/create?borrower_id='.$borrower->id)}}">
                                                    {{$borrower->trustee_mobile}}
                                                </a>
                                            </td>
                                        </tr>
                                        <tr><td>Photo</td><td> @if(!empty($borrower->trustee_photos))
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table id="loan-data-table" class="table table-condensed">
                                    ...
                                    @endforeach
                                    <tr><td colspan="5"></td><td style="font-size: 20px">Total Savings:{{number_format(\App\Helpers\GeneralHelper::savings_account_balance($borrower->id),2)}}</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        </div>
