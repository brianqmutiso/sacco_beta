            ...
            <div class="category-content no-padding">
                            ...
                            <ul class="treeview-menu">
                                ...
                                @if(Sentinel::hasAccess('borrowers.create'))
                                    <li><a href="{{ url('borrower/create') }}"><i
                                        ...
                                        <li><a href="{{ url('borrower/upload_m') }}"><i
                                                        class="fa fa-circle-o"></i> Upload {{trans_choice('general.borrower',2)}}
                                            </a></li>
                                @endif
                ...
                @if(Request::is('loan/*')) active @endif
                    ...
                    @endif
                        ...
                        @if(Sentinel::hasAccess('repayments'))
                            <li class="treeview @if(Request::is('charge/*')) active @endif">
                                <a href="#">
                                    <i class="fa fa-dollar"></i> <span>{{trans_choice('general.charge',2)}}</span>
                                </a>
                                <ul class="treeview-menu">
                                    @if(Sentinel::hasAccess('repayments.view'))
                                        <li><a href="{{ url('charge/data') }}"><i
                                                        class="fa fa-circle-o"></i> {{trans_choice('general.charge',2)}}
                                            </a></li>
                                    @endif
                                    @if(Sentinel::hasAccess('repayments.create'))
                                        <li><a href="{{ url('charge/create') }}"><i
                                                        class="fa fa-circle-o"></i> {{trans_choice('general.add',2)}} {{trans_choice('general.charge',1)}}
                                            </a></li>
                                    @endif
                        ...
                        <li class="treeview @if(Request::is('saving/*')) active @endif">
                            ...
                            <!--    @if(Sentinel::hasAccess('savings.create'))
                                    <li><a href="{{ url('saving/create') }}"><i
                                        ...
                                        -->
                                        <li><a href="{{ url('saving/savings_transaction/create') }}"><i
                                                        class="fa fa-circle-o"></i> {{trans_choice('general.add',2)}} {{trans_choice('general.saving',2)}} {{trans_choice('general.transaction',1)}}
                                            </a></li>
                                @endif
                                @if(Sentinel::hasAccess('savings.view'))
                                ...
                                @endif
                                    @if(Sentinel::hasAccess('savings.products'))
                                        <li><a href="{{ url('saving/mpesa') }}"><i
                                                        class="fa fa-circle-o"></i> Mpesa Transactions
                                            </a></li>
                                    @endif
                ...
                @if(Request::is('stock/*')) active @endif
                    ...
                    @if(Sentinel::hasAccess('other_income'))
                        <li class="treeview @if(Request::is('other_income/*')) active @endif">
                            <a href="#">
                                <i class="fa fa-plus"></i> <span>{{trans_choice('general.income',2)}}</span>
                            </a>
                            <ul class="treeview-menu">
                                @if(Sentinel::hasAccess('other_income.view'))
                                    <li><a href="{{ url('other_income/data') }}"><i
                                                    class="fa fa-circle-o"></i> {{trans_choice('general.view',2)}} {{trans_choice('general.income',1)}}
                                        </a></li>
                                @endif
                                @if(Sentinel::hasAccess('other_income.create'))
                                    <li><a href="{{ url('other_income/create') }}"><i
                                                    class="fa fa-circle-o"></i> {{trans_choice('general.add',2)}} {{trans_choice('general.income',1)}}
                                        </a></li>
                                @endif
                                @if(Sentinel::hasAccess('other_income.create'))
                                    <li><a href="{{ url('other_income/type/data') }}"><i
                                                    class="fa fa-circle-o"></i> {{trans_choice('general.manage',2)}} {{trans_choice('general.income',1)}} {{trans_choice('general.type',2)}}
                                        </a></li>
                                @endif
                            </ul>
                        </li>
