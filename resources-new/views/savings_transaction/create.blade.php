...
@section('content')
    <div class="panel panel-white">
        ...
        {!! Form::open(array('url' => url('saving/savings_transaction/store'), 'method' => 'post', 'id' => 'transaction_form', 'class' => 'form-horizontal')) !!}
        <div class="panel-body">
            <div class="form-group">
                {!! Form::label('id',trans_choice('general.borrower',1).' '.trans_choice('general.id',1),array('class'=>'col-sm-3  control-label')) !!}
                <div class="col-sm-5">
                {!! Form::select('member_id',$members,null, array('class' => 'select2 form-control','required'=>'required')) !!}
                </div>
            </div>
            <div class="form-group">
