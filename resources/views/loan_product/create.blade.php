    ...
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('accounting_rule',['cash_based'=>trans_choice('general.cash_based',1),'accrual_periodic'=>trans_choice('general.accrual_periodic',1),'accrual_upfront'=>trans_choice('general.accrual_upfront',1)],'cash_based', array('class' => 'form-control select2','id'=>'accounting_rule')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
