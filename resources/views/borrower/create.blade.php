...
@section('content')
    <div class="panel panel-white">
        ...
        {!! Form::text('church',null, array('class' => 'form-control', 'placeholder'=>trans_choice('general.church',1),'required'=>'required')) !!}
                </div>
                <div class="col-md-6">
{!! Form::label('joined_on',trans_choice('general.joined_on',1)." *",array('class'=>'')) !!}
        {!! Form::text('joined_on',null, array('class' => 'form-control ', 'placeholder'=>trans_choice('general.joined_on',1),'required'=>'required')) !!}
                </div>
            </div>
        </div>
        <div class="form-group">
...
{!! Form::label('satellite',trans_choice('general.satellite',1),array('class'=>'')) !!}
        {!! Form::text('satellite',null, array('class' => 'form-control', 'placeholder'=>trans_choice('general.satellite',1))) !!}
                </div>
                <div class="col-md-4">
{!! Form::label('region',trans_choice('general.region',1),array('class'=>'')) !!}
        {!! Form::text('region',null, array('class' => 'form-control', 'placeholder'=>trans_choice('general.region',1))) !!}
                </div>
                <div class="col-md-4">
{!! Form::label('section_fellow',trans_choice('general.section_fellow',1),array('class'=>'')) !!}
        {!! Form::text('section_fellow',null, array('class' => 'form-control', 'placeholder'=>trans_choice('general.section_fellow',1))) !!}
                </div>
            </div>
        </div>
-->
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        {!! Form::text('next_relationship',null, array('class' => 'form-control', 'placeholder'=>trans_choice('general.relationship',1))) !!}
                    </div>
                    <div class="col-md-4">
                        {!! Form::label('dob',trans_choice('general.dob',1),array('class'=>'')) !!}
                        {!! Form::text('next_dob',null, array('class' => 'form-control date-picker', 'placeholder'=>trans_choice('general.dob',1))) !!}
                    </div>
                    <div class="col-md-4">
                        {!! Form::label('id',trans_choice('general.id',1),array('class'=>'')) !!}
                        {!! Form::text('next_id',null, array('class' => 'form-control', 'placeholder'=>trans_choice('general.id',1))) !!}
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        {!! Form::label('address',trans_choice('general.address',1)." ",array('class'=>'')) !!}
                        {!! Form::text('next_postal',null, array('class' => 'form-control', 'placeholder'=>trans_choice('general.address',1))) !!}
                    </div>
                    <div class="col-md-6">
                        {!! Form::label('phone',trans_choice('general.phone',1)." ",array('class'=>'')) !!}
                        {!! Form::text('next_mobile',null, array('class' => 'form-control', 'placeholder'=>trans_choice('general.phone',1))) !!}
                    </div>
                </div>
            </div>
            <div class="form-group">
...
{!! Form::label('ownership',"Ownership",array('class'=>'')) !!}
        {!! Form::text('ownership',null, array('class' => 'form-control', 'placeholder'=>"Ownership")) !!}
                </div>
